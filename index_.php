...
<head>
   ...
   <meta property="og:site_name" content="Vipin Yadav - Full Stack Web Developer" />
   <meta name="keywords" content="Web Developer,Web Designer,Programmer,HTML5,CSS3,XML,JavaScript">
   <link rel="manifest" href="manifest.json" />

   <!-- Mobile Specific Metas
   ================================================== -->
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
   <meta name="theme-color" content="#483367">
   ...
   <link rel="stylesheet" href="sp-font.css">

   <!-- Script
   ================================================== -->
   <script async src="js/modernizr.js" ></script>
   <meta name="google-site-verification" content="roFIfyB9QDqmHMuK6mu114IdtnG5FCZ6TfW6ZWJK6rg" />
...
<body>
      ...
      <div class="row banner">
         <div class="banner-text">
            ...
            <ul class="social">
               ...
               <li><a href="https://twitter.com/vipiny35" target="_blank"><i class="fa fa-twitter"></i></a></li>
               <li><a href="https://plus.google.com/+VipinYadav1" target="_blank"><i class="fa fa-google-plus"></i></a></li>
               <li><a href="https://www.linkedin.com/in/vipiny35" target="_blank"><i class="fa fa-linkedin"></i></a></li>
               <li><a href="https://instagram.com/vip_iny" target="_blank"><i class="fa fa-instagram"></i></a></li>
               <li><a href="skype:vipiny35?chat"><i class="fa fa-skype"></i></a></li>
            </ul>
         </div>
      </div>
         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <div class="columns contact-details">
                  ...
                  <p class="address">
                     <span>Vipin Yadav</span><br>
                     <span>Mumbai<br>
                           MH 400615 IN
                     </span><br>
                     <span>(+91) 9920 688 174</span><br>
                     <span>vipin.yadav@webtiara.com</span>
                  </p>
               ...
               <!-- <div class="columns download">
                  <p>
                     <a href="resume_Vipin_Yadav_130417.pdf" download="resume_Vipin_Yadav_130417.pdf" rel="nofollow" class="button"><i class="fa fa-download"></i>Download Resume</a>
                  </p>
               </div> -->
   ...
   <div class="color-fill">
      <div class="row">
        ...
        <div class="three columns header-col">
         <h1><span>Some&nbsp;of&nbsp;my&nbsp;Work</span></h1>
        </div>
               ...
               <div class="columns portfolio-item">
                  <div class="item-wrap">
                     ...
                     <a href="#modal-02" title="">
                        <img alt="" src="images/portfolio/hb.jpg">
                        <div class="overlay">
                           <div class="portfolio-item-meta">
                              <h5>Hoolybib</h5>
                              <p>Online Blog</p>
               ...
               <div class="columns portfolio-item">
                  <div class="item-wrap">
                     ...
                     <a href="#modal-04" title="">
                        <img alt="" src="images/portfolio/rd.jpg">
                        <div class="overlay">
                           <div class="portfolio-item-meta">
                              <h5>Radiate Lights</h5>
                              <p>Web Store</p>
                           </div>
                        </div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
         ...
         <div id="modal-01" class="popup-modal mfp-hide">
            ...
            <img class="scale-with-grid" src="images/portfolio/modals/bh-modals.png" alt="" />
            ...
            <div class="link-box">
               <a href="http://bscithub.in">Details</a>
...
<!--    <section id="call-to-action">
      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="social-links">
               <li><a href="https://www.facebook.com/vipiny35" target="_blank"><i class="fa fa-facebook"></i></a></li>
               <li><a href="https://twitter.com/vipiny35" target="_blank"><i class="fa fa-twitter"></i></a></li>
               <li><a href="https://plus.google.com/+VipinYadav1" target="_blank"><i class="fa fa-google-plus"></i></a></li>
               <li><a href="https://www.linkedin.com/in/vipiny35" target="_blank"><i class="fa fa-linkedin"></i></a></li>
               <li><a href="https://instagram.com/vip_iny" target="_blank"><i class="fa fa-instagram"></i></a></li>
            ...
            <ul class="copyright">
               ...
               <li>Design by <a title="Webtiara" href="https://www.webtiara.com" target="_blank" >Webtiara</a></li>   
            </ul>
   ...
   <!-- End Cookie Consent plugin -->
	...
	<style>.cc_container .cc_btn, .cc_container .cc_btn:visited { background-color: #ec0268;}</style>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-78122984-6"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'UA-78122984-6');
	</script>
